    ...
    <div style={{backgroundColor: colors.header}}>
      <header style={{backgroundColor: colors.header}}>
        ...
        <div className="contactButtons">
          ...
          <a href="https://devpost.com/ashnakhetan/" target="_blank" className="linkedin-button">
            <DevpostIcon />
          </a>
          <a href="https://twitter.com/ashna_khetan" target="_blank" className="linkedin-button">
            <TwitterIcon />
          </a>
          <a href="https://instagram.com/ashnakhetan/" target="_blank" className="linkedin-button">
            <InstaIcon />
          </a>
      ...
      <div style={{ paddingTop: '30px', backgroundColor: colors.offwhite }}>
        ...
        {/* Section 2 */}
        <section ref={section2Ref} style={{ display: 'flex', flexDirection: 'column', backgroundColor: colors.offwhite}}>
          <h1>Projects</h1>
          <Grid container spacing={8} className="projects">
            {projectData.projects.slice(0, numProjDisplayed).map((project, index) => (
            <Grid item xs={8} md={4}>
              <ProjectCard
              id={`project-${index}`}
              key={index}
          ...
          <div style={{width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'center'}}>
            {numProjDisplayed < projectData.projects.length ? (
                    <button style={{flex: 1, marginTop: '30px'}} onClick={showMoreProjects}>See More</button>
            ) : (
              <button style={{flex: 1, marginTop: '30px'}} onClick={showLessProjects}>See Less</button>
            )}
          </div>
          </Grid>
        </section>
        ...
        <section ref={section3Ref} style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', backgroundColor: colors.offwhite, justifyContent: 'space-between', alignItems: 'center'}}>
            <Experience/>
            <footer className="footer" >made in 2023, last updated jan 2 2024, made using React.js, mui, + a little imagination, by ashna</footer>
        </section>
      </div>
