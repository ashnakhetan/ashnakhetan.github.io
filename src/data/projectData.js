    ...
    "projects": [
        {
            imageUrl: trackLab,
            name: "Tracklab",
            description: "I made this web app for my dance team to easily set breakpoints in our music!",
        ...
        },
        {
            imageUrl: wander,
            name: "Wander",
            description: "Create audio stories and listen to others' as you roadtrip.",
        ...
        },
        {
            ...
            description: "Classifies any items you hold into 8 different categories of plastic.",
        ...
        },
        {
            imageUrl: planIt,
            name: "PlanIt Student",
            description: "Time management app that provides analytics over your time-usage.",
        ...
        },
        {
            ...
            description: "Uses computer vision to detect aggressive expressions in a driver's face and prevents the driver from destructive actions.",
